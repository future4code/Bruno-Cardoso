...
// Dentro da pasta src com o comando " tsc ./exercicio-4.ts "

//c) Existe alguma maneira de transpilar múltilplos arquivos de uma 
// vez só? Caso conheça, explique como fazer.

// Dentro da pasta src com o comando " tsc ./*.ts "
